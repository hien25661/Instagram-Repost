...
public class PaperOnboardingEngine implements PaperOnboardingEngineDefaults {
    ...
    public boolean isShowIconFirst = true;
    ...
    protected void initializeStartingState() {
        ...
        if(isShowIconFirst && mActiveElementIndex == 0){
            initContentIcon.setVisibility(View.VISIBLE);
        }else {
            initContentIcon.setVisibility(View.VISIBLE);
        }
        // initial bg color
    ...
    protected void toggleContent(boolean prev) {
        ...
        if(isShowIconFirst && mActiveElementIndex == 0){
            newContentIcon.setVisibility(View.VISIBLE);
        }else {
            newContentIcon.setVisibility(View.VISIBLE);
        }
