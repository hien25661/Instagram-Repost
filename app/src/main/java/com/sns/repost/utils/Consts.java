...
public class Consts {
    ...
    public static Request requestreformer(Request paramRequest) {
        return paramRequest.newBuilder().
                header("User-Agent", "Instagram 8.0.0 Android (18/4.3; 320dpi; 720x1280; Xiaomi; HM 1SW; armani; qcom; en_US)").header("Connection", "close").header("Accept-Language", "en-US").header("Content-Type", "application/x-www-form-urlencoded;charset=UTF-8").header("Accept", "*/*").header("Cookie2", "$Version=1")
